...
func TestPersist22C(t *testing.T) {
	...
	for iters := 0; iters < 5; iters++ {
		...
		//fmt.Println("reconnecting", (leader1+1)%servers, (leader1+2)%servers, "with applier")
		...
		//fmt.Println("reconnecting", (leader1+3)%servers, "with applier")
		...
		//fmt.Println("reconnecting", (leader1+4)%servers, (leader1+0)%servers, "with applier")
		cfg.connect((leader1 + 4) % servers)
		cfg.connect((leader1 + 0) % servers)
	}
